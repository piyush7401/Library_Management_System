<!-- e will make function which will be used for multiple time under this system. So for this, we have make all function under this function.php file, so by simply include this file any PHP file we can use that function. -->
